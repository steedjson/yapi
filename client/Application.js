...
// 路由级代码分割：统一工厂已下沉 client/components/AsyncComponent（插件同源共用）。
// 加载期展示全局 Loading；loader 内必须带 webpackChunkName 注释以命名异步 chunk
// （project/group/user 等），使 static/prd/ 下产出独立分包，缩小首屏主包体积。
