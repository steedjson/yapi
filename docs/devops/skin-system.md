...
| 皮肤 | data-skin | 特征 |
|---|---|---|
| 企业风（默认） | 不设置 | 现状配色，零额外加载 |
| 政务风 | `gov` | 主色 #1e4f9c、深蓝顶栏 #16325c、冷灰底 #f0f2f5、圆角 2px |
| 二次元风 | `anime` | 主色 #a05ce6、浅粉顶栏 #f8c8dc + 深玫瑰文字、粉底 #fff7fb、圆角 12px、深玫瑰下拉浮层 |
| 暗色 | `dark` | 底 #1f1f1f / 组件 #2a2a2a / 文字 #d9d9d9（尽力而为半成品，见边界） |
